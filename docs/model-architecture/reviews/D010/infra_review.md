...
That conclusion predates the canonical builder and its no-clobber/fsync publication
path. Fresh independent review must confirm bounded startup memory, publication failure
semantics, and unchanged streaming behavior before this file may record a current PASS.
